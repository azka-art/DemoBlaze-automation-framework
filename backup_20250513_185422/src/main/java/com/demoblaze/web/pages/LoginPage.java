...
public class LoginPage extends BasePage {
    ...
    private By errorAlertLocator = By.xpath("//div[@class='modal-body']//p[contains(@class,'text-danger')]");
    ...
    public boolean isLoggedIn() {
        try {
            ...
            return loggedInUser.isDisplayed() && !loggedInUser.getText().isEmpty();
        } catch (Exception e) {
            return false;
        }
    }
    ...
    public String getErrorMessage() {
        try {
            ...
            // Try to find error in modal
            try {
                WebElement errorElement = driver.findElement(errorAlertLocator);
